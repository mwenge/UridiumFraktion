...
\footnote{In the extract opposite, to keep the code legible and fit the routine on a single page I have removed some of the verbose book-keeping that 6502 assembly code requires. For example \fcode{CLC} instructions which are sometimes necessary before an addition operation are omitted.}.
