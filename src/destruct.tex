...
\fcode{DisintegrateDreadnought}. Each time it's called it draws the edge of
...
With this we can advance the wave inexorably, calling \fcode{DisintegrateDreadnought}
