...
that we call \fcode{BulletBlocked} when the we overlap a character with a value between \icode{\$80} and
\icode{\$8F}.
...
state of the six bullets thar active at any given time. This array is called \fcode{playerBulletSlotArray}.
