...
\begin{figure}[H]
  \centering
  \begin{adjustbox}{width=11.0cm,center}
...
\begin{minipage}[c]{0.46\linewidth}
  \vspace{-0.3cm}
	\begin{figure}[H]
		\centering
		\begin{adjustbox}{width=6.0cm,right}
...
is a diverse set of movement strategies in play. Even with just three enemies in a formation, such
as this example from Level 3 (\textit{Copper}), we find pleasant serpentine configurations.

\begin{figure}[H]
  \centering
  \begin{adjustbox}{width=13.0cm,left}
    \includegraphics{src/formation_movement/level_formation_diagrams/3_formation_movement_0_33.png}%
  \end{adjustbox}
\end{figure}
\vspace{-0.6cm}

In this example from Level 5 (\textit{Iron}), enemies
