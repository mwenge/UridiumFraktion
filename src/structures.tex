...
Below is what one of them, \icode{\$15}, looks like when replicated across a section creating a a diamond of plinths, along
...
By defining our placement instructions as follows:
...
that performs this activity. We observe how the inner loop \fcode{DrawStructure} is responsible
for consuming and rendering the data for each specified structure, while the outer loop \fcode{DrawPlacedStructures}
