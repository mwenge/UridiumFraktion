...
\raisebox{-0.1\totalheight}{\includegraphics[height=3cm]{src/surface_structure_diagrams/6_1E_no_text.png}}
\hspace{0.4cm}
\raisebox{-0.1\totalheight}{\includegraphics[height=3cm]{src/surface_structure_diagrams/6_1D_no_text.png}}
\hspace{0.4cm}
\raisebox{-0.1\totalheight}{\includegraphics[height=3cm]{src/surface_structure_diagrams/6_15_no_text.png}}
\hspace{0.4cm}
\raisebox{-0.1\totalheight}{\includegraphics[height=3cm]{src/surface_structure_diagrams/6_51_no_text.png}}
...
\raisebox{-0.1\totalheight}{\includegraphics[height=3cm]{src/surface_structure_diagrams/6_6A_no_text.png}}
\hspace{0.4cm}
\raisebox{-0.1\totalheight}{\includegraphics[height=3cm]{src/surface_structure_diagrams/6_11_no_text.png}}
\hspace{0.4cm}
\raisebox{-0.1\totalheight}{\includegraphics[height=3cm]{src/surface_structure_diagrams/6_53_no_text.png}}

And other interesting structures;

\raisebox{-0.1\totalheight}{\includegraphics[height=3cm]{src/surface_structure_diagrams/6_6B_no_text.png}}
\hspace{0.4cm}
\raisebox{-0.1\totalheight}{\includegraphics[height=3cm]{src/surface_structure_diagrams/6_91_no_text.png}}
\hspace{0.4cm}
\raisebox{-0.1\totalheight}{\includegraphics[height=3cm]{src/surface_structure_diagrams/6_68_no_text.png}}
\hspace{0.4cm}
\raisebox{-0.1\totalheight}{\includegraphics[height=3cm]{src/surface_structure_diagrams/6_65_no_text.png}}
...
\raisebox{-0.1\totalheight}{\includegraphics[height=3cm]{src/surface_structure_diagrams/6_54_no_text.png}}
\hspace{0.2cm}
\raisebox{-0.1\totalheight}{\includegraphics[height=3cm]{src/surface_structure_diagrams/6_1F_no_text.png}}
\hspace{0.2cm}
\raisebox{-0.1\totalheight}{\includegraphics[height=3cm]{src/surface_structure_diagrams/6_19_no_text.png}}
\hspace{0.4cm}
\raisebox{-0.1\totalheight}{\includegraphics[height=3cm]{src/surface_structure_diagrams/6_18_no_text.png}}
\hspace{0.2cm}
\raisebox{-0.1\totalheight}{\includegraphics[height=3cm]{src/surface_structure_diagrams/6_52_no_text.png}}
...
\end{figure}
\vspace{-0.6cm}
With this in mind, we can take our time reading the routine
that performs this activity at our leisure. We observe how the inner loop \icode{DrawStructure} is responsible
for consuming and rendering the data for each specified structure, while the outer loop \icode{DrawPlaceStructures}
manages the business of reading in the list of structures to render. Notice how at the start we read in the address
