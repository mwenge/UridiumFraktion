...
With the details of each section defined in its own section array, we will now define an array that references each section array. A 'list of lists' if you like.
...
in which to place the sections. This order is important because when we draw one sprite after another it will appear
'over it', occluding any overlapping area.
...
loPtrsToDropShipSections
  ...
  .BYTE <landingDeckSection,  <bayDoorSection     ; %\raisebox{-0.2\totalheight}{\includegraphics[height=0.31cm]{src/dropship_sprites/DROPSHIP_6.png}}% %\raisebox{-0.2\totalheight}{\includegraphics[height=0.31cm]{src/dropship_sprites/DROPSHIP_7.png}}%
\end{lstlisting}
...
The illustration below shows how the craft is built up in practice. We start with the landing deck and proceed
