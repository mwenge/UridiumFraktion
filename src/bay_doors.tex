...
\begin{figure}[H]
    ...
    \begin{adjustbox}{center}
      ...
      \hspace{0.7cm}
      \raisebox{1.1\totalheight}{\includegraphics[height=0.6cm]{src/baydoor_sprites/arrow.png}}
      \hspace{0.5cm}
...
landing deck below, because it is drawn after it in the order we defined in \fcode{loPtrsToDropShipSections} in the previous
chapter.
...
same as the \fcode{landingDeckSection} we looked at earlier - because we are drawing over it in order to cover
...
bayDoorSection
  ...
  .BYTE%\raisebox{-0.2\totalheight}{\includegraphics[height=0.4cm]{src/baydoor_sprites/DROPSHIP_7.png}}%         ; Sprite Value ($07).
\end{lstlisting}
...
-
\raisebox{-0.2\totalheight}{\includegraphics[height=0.4cm]{src/baydoor_sprites/DROPSHIP_7.png}}
) 
to the final, fully open position (\icode{11} - 
\raisebox{-0.2\totalheight}{\includegraphics[height=0.4cm]{src/baydoor_sprites/DROPSHIP_11.png}}
).
...
The full effect of this procedure is given again below, showing us paint the closed dropship door (\fcode{DROPSHIP\_7})
all the way up to the door when fully open (\fcode{DROPSHIP\_11}):

\raisebox{-0.2\totalheight}{\includegraphics[height=1.5cm]{src/baydoor_sprites/baydoor_animation_7.png}}
\hspace{0.1cm}
\raisebox{-0.2\totalheight}{\includegraphics[height=1.5cm]{src/baydoor_sprites/baydoor_animation_8.png}}
\hspace{0.1cm}
\raisebox{-0.2\totalheight}{\includegraphics[height=1.5cm]{src/baydoor_sprites/baydoor_animation_9.png}}
\hspace{0.1cm}
\raisebox{-0.2\totalheight}{\includegraphics[height=1.5cm]{src/baydoor_sprites/baydoor_animation_10.png}}
\hspace{0.1cm}
\raisebox{-0.2\totalheight}{\includegraphics[height=1.5cm]{src/baydoor_sprites/baydoor_animation_11.png}}

Once the bay doors have opened. The Manta can emerge. To achieve this we replace the sprite used for the bay door
(defined in \fcode{bayDoorSection}) with a new definition we call \fcode{mantaTakingOff}. Notice that the 'index'
...
mantaTakingOff
  ...
  .BYTE %\raisebox{-0.2\totalheight}{\includegraphics[height=0.4cm]{src/baydoor_sprites/manta_animation_sprite.png}}%      ; Sprite Value ($59).
\end{lstlisting}

To swap out \fcode{bayDoorSection} with \fcode{mantaTakingOff} we must load \fcode{mantaTakingOff} into memory. The fact that
it has the same index of \icode{'06'} ensures that we replace \fcode{bayDoorSection}:
\begin{lstlisting}
...
\raisebox{-0.2\totalheight}{\includegraphics[height=1.5cm]{src/baydoor_sprites/manta_animation_0.png}}
\hspace{0.1cm}
\raisebox{-0.2\totalheight}{\includegraphics[height=1.5cm]{src/baydoor_sprites/manta_animation_5.png}}
\hspace{0.1cm}
\raisebox{-0.2\totalheight}{\includegraphics[height=1.5cm]{src/baydoor_sprites/manta_animation_10.png}}
\hspace{0.1cm}
\raisebox{-0.2\totalheight}{\includegraphics[height=1.5cm]{src/baydoor_sprites/manta_animation_15.png}}
\hspace{0.1cm}
\raisebox{-0.2\totalheight}{\includegraphics[height=1.5cm]{src/baydoor_sprites/manta_animation_20.png}}
\hspace{0.1cm}
\raisebox{-0.2\totalheight}{\includegraphics[height=1.5cm]{src/baydoor_sprites/manta_animation_25.png}}
...
\begin{figure}[H]
    \centering
    \begin{adjustbox}{center}
      \includegraphics[width=1cm]{src/manta_sprites/MANTA1.png}%
      \hspace{0.1cm}
      \includegraphics[width=1cm]{src/meanie_sprites/MEANIE_09.png}%
    \end{adjustbox}
\end{figure}
\vspace{-0.5cm}

However during the dropship sequence this shared color is a dull grey, the shadow tones used to
